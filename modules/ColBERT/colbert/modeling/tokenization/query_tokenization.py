...
class QueryTokenizer():
    ...
    def tensorize(self, batch_text, bsize=None, padding="longest", context=None, full_length_search=False):
        assert type(batch_text) in [list, tuple], (type(batch_text))
        ...
        if full_length_search:
            ...
            un_truncated_ids = self.tok(batch_text, add_special_tokens=False,
